...
int main()
{
	...
	AutomatDetermin AutomatDeterminization;
	...
	while (!inputF.eof()) {
		getline(inputF, automatType);
			...
			AutomatDeterminization.ShowGrammar(AutomatDeterminization.Determine(AutomatDeterminization.ReadTransitions(inputF, automatType)));
			// 
			//matrica = AutomatDeterminization.ReadTransitions(inputF, automatType);
			//AutomatMinim.ShowTransposition(matrica);
			// 
			...
			//AutomatMinim.ShowTransposition(AutomatDeterminization.Determine(AutomatMinim.EditingForOutput(matrica, AutomatMinim.Minimization(matrica, AutomatMinim.GetTerminalStatesNumber()), AutomatMinim.GetTerminalStatesNumber())));
			//AutomatMinim.ShowTransposition(AutomatDeterminization.Determine(matrica));
